...
# Documentation:
  See the files with the word 'documentation' in their names. There are HTML, PDF and TXT doc.

## Doc snippets:
  after benchmark-blender.pl -h

Blender Automated Benchark Suite (BABS), version 0.3,
